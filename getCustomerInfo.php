getCustomerInfo.php  ←------------------save in htdocs in xampp
<?php
// Get a connection for the database
require_once('../mysqli_connect.php'); ←--this assumes you put mysqli in xampp and not htdocs

// Create a query for the database
$query = "SELECT firstName, lastName, emailAdd, street, city, state, zipCode,
phone, birthDate FROM Customer";
